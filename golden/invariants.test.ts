...
const MUTATIONS: Mutation[] = [
  ...
  {
    name: 'мелкая точка растёт быстрее ведущей ширины',
    damage: 'карман обгоняет грудь и на большом размере вещь становится другой моделью',
    mutate: (s) =>
      points(s, (p) =>
        p.code === 'T12'
          ? {
              ...
              graded: p.graded.map((g) => ({
                ...g,
                value: { ...g.value, value: p.base.value + (g.ru - 46) * 1.6 },
              })),
            }
          : p,
      ),
