...
import type { GradedValue, Measurements, PomValue } from '@seamster/stylespec';
...
function calibrate(
  ...
  if (!computed) {
    throw new SeamsterError('SPEC_INVALID', `ручной замер для неизвестной точки ${manual.code}`, {
