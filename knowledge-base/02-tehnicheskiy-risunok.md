...
⚠️ Формального стандарта обозначений (аналога ЕСКД для одежды) нет — зафиксировать **внутренний стандарт условных обозначений SpecForm** на основе этой таблицы.
